...
class ESILevel(int, Enum):
    """Emergency Severity Index - 1 is most critical"""
    RESUSCITATION = 1
    EMERGENT = 2
    URGENT = 3
    SEMI_URGENT = 4
...
class TriageAction(BaseModel):
    """Action space for the medical triage agent"""
...
class TriageReward(BaseModel):
    """Reward signal with partial progress components"""
